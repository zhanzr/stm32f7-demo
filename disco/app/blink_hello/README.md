...
| `ADC_CHANNEL_TEMPSENSOR` | die temperature sensor | **°C** (two-point factory calibration) |
...
30 °C, `TS_CAL2` @ `0x1FF0F44E` = 110 °C, acquired at Vref+ = 3.3 V):

* `VDDA = 3300 mV × VREFINT_CAL / VREFINT_raw`
...
* `VBAT = 4 × VBAT_raw × VDDA / 4095` (channel is a `/4` divider)
