/**
  * @file    board.c
  * @brief   Board init for the STM32F746ZG (NUCLEO-F746ZG) benchmark builds.
  *
  ...
  * is the on-chip 320 KB (DTCM 64 KB + SRAM1 112 KB + SRAM2 16 KB + SRAM4 4 KB + backup SRAM 4 KB).
  */
 ...
 * write-back cacheable) and denies the rest. The F746 Nucleo has no external
...
/* ------------------------------------------------------------------------ */
/* Clock tree as in the vendor NUCLEO-F746ZG template (HSE 8 MHz bypass ->
