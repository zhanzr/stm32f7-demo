# Shared STM32F746ZG (NUCLEO-F746ZG) board layer for the benchmark projects.
...
set(NUCLEO_ROOT
    ...
    "Root of the nucleo-f746 board tree (contains board/, cmake/, bare/)")

set(BOARD_DIR ${NUCLEO_ROOT}/board)

# Linker script for the STM32F746ZGTx build (1 MB flash, DTCM/SRAM RW/ZI).
set(F746_LINKER_SCRIPT "${BOARD_DIR}/stm32f746xx.ld" CACHE FILEPATH
    "Linker script for the STM32F746 build")
...
set(F746_SYSTEM_SOURCE "${BOARD_DIR}/system_stm32f7xx.c" CACHE FILEPATH
    "System init source for the STM32F746 build")

function(stm32f746_apply_board TGT OPT)
    ...
    target_sources(${TGT} PRIVATE
        ...
        ${BOARD_DIR}/startup_stm32f746xx.s
        ${F746_SYSTEM_SOURCE}
    ...
    if(STM32_STARM_CLANG)
        ...
        set(_LDFLAGS "${_LDFLAGS} -Xlinker -T -Xlinker ${F746_LINKER_SCRIPT}")
        ...
        set(_LDFLAGS "${_LDFLAGS} -T ${F746_LINKER_SCRIPT}")
