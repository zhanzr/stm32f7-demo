...
/* NUCLEO-F746ZG LEDs (same wiring as the nucleo-f722): LD1 PB0 green,
 * LD2 PB7 blue, LD3 PB14 red - all high active. */
const LED_NAMES = ['LD1 (green, PB0)', 'LD2 (blue, PB7)', 'LD3 (red, PB14)'];
let ledStates = [0, 0, 0];
